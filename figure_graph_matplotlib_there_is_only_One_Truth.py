...
x=[1,2,3,4,5,6,7]
y=[77,89,101,113,125,137,149]
yi=y.reverse()
print(y.reverse())
xx=[7,6,5,4,3,2,1]
###The is only one Truth and it never changes
yy=[149,137,125,113,101,89,77]
###yy=[77,88,99,110,121]
...
##for x=[1,2,3,4,5] y=[77,88,99,110,121] xx=[5,4,3,2,1] yy=[121,111,99,88,77]
graph_1xy.set_title('There is only one Truth and it never changes. The Truth (is) : God the Almighty and his only begotten Son (is) : The Lord Jesus Christ.')
